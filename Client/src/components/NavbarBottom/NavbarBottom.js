    ...
    <div className="NavbarBottom">
      ...
      {playlist.map((playlist) => (
        ...
        <div className="playlist-list">
          ...
          <h4 onClick={() => navigate(`/playlist/${playlist._id}`)}>{playlist.playlistName}<i class="fa-solid fa-minus" id="delete" onClick={deletePlaylist.bind(this,playlist._id)}  style={{marginTop: "5px"}}></i>
          </h4>
        </div>
        <Outlet/>
      </div>
